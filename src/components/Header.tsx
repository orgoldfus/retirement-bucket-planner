...
const Header: React.FC<HeaderProps> = ({ selectedTimeFrame, setSelectedTimeFrame }) => {
  return (
    <header className="mb-6">
      <div className="flex flex-col md:flex-row items-center justify-between bg-primary-500 p-4 border-3 border-black shadow-brutal mb-4">
        <div className="flex items-center mb-4 md:mb-0">
          ...
          <h1 className="text-3xl font-brutal font-bold text-white">Retirement Bucket Planner</h1>
        </div>
        <div className="w-full md:w-auto">
          <div className="font-brutal font-bold text-white mb-1">Historical Data Timeframe:</div>
      ...
      <div className="p-4 bg-white border-3 border-black shadow-brutal font-brutal">
        <p>Plan your retirement savings by configuring time-based buckets, allocating assets, and simulating withdrawals.</p>
      </div>
    </header>
  );
};
