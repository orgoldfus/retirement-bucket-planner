      ...
      <div className="bg-neutral-900 text-white p-4 border-3 border-black shadow-brutal font-brutal">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-sm text-neutral-300">
              A planning tool to help allocate retirement savings across time
              buckets
            </p>
          </div>
          <div className="mt-4 md:mt-0 text-center md:text-right">
            ...
            <p className="text-xs text-neutral-400 mt-1">
              Historical data is for illustrative purposes only. Past
        ...
        <div className="flex justify-center mt-2">
          <p className="text-xs text-neutral-400 mt-1">
            Built with ❤️ by{" "}
            <a
              href="https://www.linkedin.com/in/or-goldfus/"
              className="underline"
            >
              Or Goldfus
            </a>
