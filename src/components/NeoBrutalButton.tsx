...
const NeoBrutalButton: React.FC<NeoBrutalButtonProps> = ({
  ...
  const variantClasses = {
    ...
    warning: 'bg-warning-500 hover:bg-warning-600 active:bg-warning-700 text-black',
  ...
  const baseClasses = 'font-brutal font-bold border-3 border-black shadow-brutal transition-transform active:translate-y-1 active:translate-x-1 active:shadow-none transform hover:-translate-y-0.5 hover:-translate-x-0.5';
